...
# Small step of the left-point method
Leftpoint_small_step <- function(chain_state, first_integral, second_integral) {
  x0 <- chain_state$position
  v0 <- chain_state$momentum
  
  gradiant <- gradlogtarget(x0)
...
# Big step of the left-point method
Leftpoint_big_step <- function(chain_state, first_integral, second_integral) {
  x0 <- chain_state$position
  v0 <- chain_state$momentum
...
coupled_kernel <- function(chains) {
  ...
  small_step_chain <- Leftpoint_small_step(small_step_chain, first_integral_1, second_integral_1)
  small_step_chain <- Leftpoint_small_step(small_step_chain, first_integral_2, second_integral_2)
  ...
  big_step_chain <- Leftpoint_big_step(big_step_chain, first_big_integral, second_big_integral)
